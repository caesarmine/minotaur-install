...
with open("/etc/miner-startup.sh","w") as f:
  ...
  f.write("mkdir /var/log/minotaur\n")
  f.write("chown miner:miner /var/log/minotaur\n")
  f.write("chown miner:miner /var/log/minotaur\n")
  f.write("mkdir /var/run/gpustatd\n")
  f.write("mkdir /var/log/gpustatd\n")
  f.write("chown miner:miner /var/log/gpustatd\n")
  f.write("chown miner:miner /var/run/gpustatd\n")
  f.write("mkdir /var/run/excavataur\n")
  f.write("mkdir /var/log/excavataur\n")
  f.write("chown miner:miner /var/log/excavataur\n")
