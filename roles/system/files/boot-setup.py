...
with open("/etc/miner-startup.sh","w") as f:
  ...
  f.write("sleep 5\n")
  f.write("mkdir -p /var/run/minotaur\n")
  f.write("mkdir -p /var/log/minotaur\n")
  f.write("chown -R miner:miner /var/log/minotaur\n")
  f.write("chown -R miner:miner /var/log/minotaur\n")
  f.write("mkdir -p /var/run/gpustatd\n")
  f.write("mkdir -p /var/log/gpustatd\n")
  f.write("chown -R miner:miner /var/log/gpustatd\n")
  f.write("chown -R miner:miner /var/run/gpustatd\n")
  f.write("mkdir -p /var/run/excavataur\n")
  f.write("mkdir -p /var/log/excavataur\n")
  f.write("chown -R miner:miner /var/log/excavataur\n")
  f.write("chown -R miner:miner /var/run/excavataur\n")
